...
func TestCheckCloud_Above(t *testing.T) {
	...
	point_from_price := ichimoku.NewPoint(decimal.NewFromInt(1668497400/1000), d(9670))
...
func TestCheckCloud_below(t *testing.T) {
	...
	line_helper := ichimoku.NewLineHelper()
	point_from_price := ichimoku.NewPoint(decimal.NewFromInt(1667284200/1000), d(8360))
	res_senko_a, err := line_helper.GetCollisionWithLine(point_from_price, h1_above_)
...
func TestCheckCloud_below1(t *testing.T) {
	...
	line_helper := ichimoku.NewLineHelper()
	point_from_price := ichimoku.NewPoint(decimal.NewFromInt(1666074600/1000), d(8650))
	res_senko_a, err := line_helper.GetCollisionWithLine(point_from_price, h1_above_)
...
func TestCheckCloud_below3(t *testing.T) {
	...
	line_helper := ichimoku.NewLineHelper()
	point_from_price := ichimoku.NewPoint(decimal.NewFromInt(1667284200/1000), decimal.NewFromInt(8360))
	res_senko_a, err := line_helper.GetCollisionWithLine(point_from_price, h1_above_)
